...
using TiledMMA_dQ = decltype(make_tiled_mma(
    SM100_MMA_F16BF16_2x1SM_TS_NOELECT<bf16, bf16, float, B_H/2, 256, UMMA::Major::MN, UMMA::Major::MN>{}
));

using TiledMMA_dQ_RoPE = decltype(make_tiled_mma(
    SM100_MMA_F16BF16_2x1SM_TS_NOELECT<bf16, bf16, float, B_H/2, D_ROPE, UMMA::Major::MN, UMMA::Major::MN>{}
));
...
struct tmem_cols {
    ...
    // Shape: [B_TOPK, 256] × 2 = [32, 512], 每部分需要 32*512/128 = 128 列
