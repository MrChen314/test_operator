"""
Setup script for test_2sm_mma_peer_cuda extension.
Compiles the CUDA kernel for testing utcmma_ss_peer on SM100 (Blackwell).
"""
...
ext_modules = [
    CUDAExtension(
        name="test_2sm_mma_peer_cuda",
        sources=["test_2sm_mma_peer.cu"],
        extra_compile_args={
            "cxx": cxx_flags,
            "nvcc": nvcc_flags,
        },
